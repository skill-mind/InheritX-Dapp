...
export default function FaqLayout({ faqs, activeTab, setActiveTab }: FaqProps) {
  ...
  return (
    <section className="px-4">
      {/* Heading */}
      <div className="max-w-2xl md:max-w-[948px] text-center mx-auto mb-10 md:mb-16 py-8">
        <DirectionAnimation>
          <h1 className="text-3xl md:text-[72px] font-semibold mb-5">
            Frequently Asked Questions
          </h1>
        </DirectionAnimation>
        <DirectionAnimation delay={0.5}>
          <p className="text-gray-300 text-[18px] md:text-base max-w-[862px] mt-14  mx-auto">
      ...
      <div className="flex flex-col gap-[60px] items-center justify-center text-center py-5 px-6">
        <div className="flex flex-col items-start gap-1 max-w-2xl md:max-w-3xl mx-auto">
          {faqs.map((faq, index) => (
            <DirectionAnimation delay={index * 0.1}>
              <div
                key={faq.id}
