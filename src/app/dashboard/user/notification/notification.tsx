...
function Notification() {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      time: "1h ago",
      message:
        "KYC submission received and is under review. Please check your email regularly for updates",
      read: false,
      icon: "profile",
    },
    {
    ...
    },
    {
      ...
      time: "1h ago",
      message:
        "KYC submission rejected. Name on profile and means of identity do not match. Please restart verification process.",
      read: false,
      icon: "profile",
    },
    {
      ...
      time: "Yesterday",
      message:
        "Claim request validated. Check your wallet for changes and claims page to view claim details.",
      read: false,
      icon: "claims",
    },
    {
      ...
      time: "Yesterday",
      message:
        "Claim request received and is under review. Please check your email regularly for updates.",
      read: false,
      icon: "claims",
    },
    {
      ...
      time: "Yesterday",
      message:
        "You have unclaimed inheritance. Please check your email for your claim code",
      read: false,
      icon: "claims",
    },
  ]);
  ...
  const markAllAsRead = () => {
    setNotifications(
      notifications.map((notif: Notification) => ({ ...notif, read: true }))
    );
  };
...
function NotificationCard({ notification, onView }: NotificationCardProps) {
  return (
    <div className="bg-gradient-to-b from-gray-300/20 via-gray-500/20 to-gray-700/20 border border-gray-600 rounded-xl p-4 flex items-center">
      ...
      <button onClick={onView} className="ml-4 text-white">
        View
      </button>
    </div>
  );
