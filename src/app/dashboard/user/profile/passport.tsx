            ...
            <div className="w-full max-w-md space-y-8">
                <div className="rounded-lg p-6 bg-[#201F2A] border border-gray-400 w-[400px] h-[200px]">
                    <div>
                        ...
                        <div
                            ...
                            onClick={() => idInputRef.current && triggerFileInput(idInputRef as React.RefObject<HTMLInputElement>)}
                        >
                ...
                <div className="rounded-lg p-6 w-2xl bg-[#201F2A] border border-gray-400 w-[400px] h-[300px]">
                    ...
                    <div
                        ...
                        onClick={() => addressInputRef.current && triggerFileInput(addressInputRef as React.RefObject<HTMLInputElement>)}
                    >
                        <div className="flex flex-col items-center justify-center">
                            <Image
                                src="/upload-symbol.svg"
