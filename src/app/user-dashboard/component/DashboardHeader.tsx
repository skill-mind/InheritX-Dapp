  ...
  return (
    <header className="pt-2 relative">
      <div className="flex justify-between items-center pt-2 md:px-7 pr-8 sm:px-6">
        ...
        <nav className="">
          {pathname === "/dashboard" ? (
            <h1 className="text-[40px] font-normal text-[#FCFCFC]">
              Dashboard
            </h1>
          ) : (
              ...
              <div key={item.name} className="flex items-center">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === item.href ? "text-[#FCFCFC]" : "text-[#ffffff]"
                  )}
                >
                  {item.name}
                </Link>
        ...
        <div className="hidden lg:flex items-center gap-4 relative">
          ...
          <div className="relative">
            <button
              ...
              className="w-10 h-10 rounded-full bg-[#121217] flex items-center justify-center border border-[#4a4950] hover:bg-[#1D1D1C] transition-colors"
            >
          ...
          <div className="relative" ref={profileRef}>
            <button
              ...
              className="flex items-center gap-2 hover:bg-[#FFFFFF1A] bg-[#161716] p-2 rounded-full cursor-pointer border border-[#4a4950]"
            >
              <Image
                src={Avatar}
                width={25}
