        ...
        >
          <div>
            ...
            <p className="text-[10px] font-light text-white ">
              ...
              <span className="text-[#C5AAFF] font-semibold"> FAQs </span>don't
              answer your question, submit a support ticket, and our team will
              assist you within 24 business hours.
            </p>
          </div>
