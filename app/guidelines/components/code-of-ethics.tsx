      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto space-y-10 md:space-y-12 lg:space-y-16  flex flex-col items-center">
          ...
          <header className="space-y-6 md:space-y-5">
            ...
            <p className="text-xl md:text-base lg:text-[15px] leading-relaxed md:leading-relaxed lg:leading-relaxed max-w-4xl mx-auto text-center px-4 md:px-6 lg:px-8 ">
          ...
          {/* Ethics Sections */}
          <div className="space-y-12 md:space-y-12 lg:space-y-16 md:w-[950px] bg-gradient-to-b from-[#323246] to-[#14101c] md:px-7 rounded-2xl">
